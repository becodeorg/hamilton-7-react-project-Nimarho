...
const MainBody = () =>{
    ...
    const altImg = "/1F3AE.svg";
    console.log(mainContent);
    if (mainContent.length === 0) {
        return(
            <div className="w-full items-center">
                <div role="status">
                    <svg aria-hidden="true" className="mr-2 w-8 h-8 text-gray-200 animate-spin dark:text-red-600 fill-yellow-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <span className="sr-only">Waiting on RAWG</span>
                </div>
            </div>
        );
    }else{
